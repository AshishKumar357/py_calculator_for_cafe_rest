...
lblInfo = Label(Tops, font=('arial', 50, 'bold'), text="SUPER CAFETERIA ", fg="Steel Blue", bd=10, anchor='w')
...
def Ref():
    ...
    Central_GST = (((CostofPasta + CostofDrinks + CostofDosa + CostofIceCream + CostBurger + CostTea) * 2.5) / 100)

    State_GST = (((CostofPasta + CostofDrinks + CostofDosa + CostofIceCream + CostBurger + CostTea) * 2.5) / 100)

    Total_cost = (CostofPasta + CostofDrinks + CostofDosa + CostofIceCream + CostBurger + CostTea)

    CostofMeal = "Rs", str('%.2f' % (CostofPasta + CostofDrinks + CostofDosa + CostofIceCream + CostBurger + CostTea))
...
txtSgst = Entry(f1, font=('arial', 16, 'bold'), textvariable=Sgst, bd=10, insertwidth=4, bg="powder blue",
                justify='right')
txtSgst.grid(row=2, column=3)

lblCgst = Label(f1, font=('arial', 16, 'bold'), text="CGST", bd=16, anchor="w")
lblCgst.grid(row=3, column=2)
txtCgst = Entry(f1, font=('arial', 16, 'bold'), textvariable=Cgst, bd=10, insertwidth=4, bg="powder blue",
                justify='right')
